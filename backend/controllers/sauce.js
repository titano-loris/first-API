...
const fs = require('fs'); // file systeme est un module pour utiliser les fichier d'image
...
exports.deleteSauce = (req, res, next) => {
    Sauce.findOne({ _id: req.params.id })
        .then(sauce => {
            if (sauce.userId != req.auth.userId) { //on s'assure que c'est bien l'utilisateur qui s'upprime sa sauce
